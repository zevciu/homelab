...
source "$GLOBAL_OPS_DOCKER_LIB_DIR/get_health_state.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/setup_config.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/bootstrap_config.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/seed_config.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/apply_config.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/apply_permissions.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/compare_dirs.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/get_drift_direction.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/backup_config.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/export_from_runtime.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/guard_direction.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/stop_containers.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/destroy_environment.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/deploy_containers.sh"
source "$GLOBAL_OPS_DOCKER_LIB_DIR/plan_service.sh"
